...
def hbnb_filters():
    ...
    return render_template('2-hbnb.html', states=states, cities=cities, amenities=amenities, cities_by_state=cities_by_state, places=places, cache_id=str(uuid.uuid4()))
