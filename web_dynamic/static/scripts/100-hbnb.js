$(document).ready(function() {
    ...
    function updateCitiesHeader() {
        ...
        if (selectedCitiesHeader.length > 0 && selectedCitiesHeader.length < 4) {
            $('h5').text(selectedCitiesHeader.join(', '));
        } else if (selectedCitiesHeader.length >= 4) {
            var truncatedText = selectedCitiesHeader.slice(0, 3).join(', ') + ' ...';
